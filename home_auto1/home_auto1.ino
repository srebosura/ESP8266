...
client.println("<h4><center><font face=\"Verdana\" size=\"16\" color=\"#E11711\"> Home Automation v1.01 </font></center></h4>");
client.println("<hr/><hr>");
...
client.println("<br><br>");
client.println("<center>");
client.println("<font face=\"Arial Italic\" size=\"10\" color=\"#000000\">https://github.com/srebosura/ESP8266</font>");
client.println("</center>");
client.println("</html>"); 
